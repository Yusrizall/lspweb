            ...
            <div class="card bg-secondary text-white">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <a class="btn btn-warning ml-auto" href="/products">Master Produk</a>
                    </div>
                    <hr>
                    <table class="table table-bordered m-0">
                        ...
                        <tbody class="text-white">
                            ...
                            @else
                            <tr>
                                <td class="text-center" colspan="5">Tidak ada produk untuk dijual</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
            ...
            <div class="card bg-secondary text-white">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <button class="btn btn-danger ml-auto" wire:click="clearCart()">Hapus Keranjang</button>
                    </div>
                    <hr>
                    ...
                    <form wire:submit.prevent="checkout">
                        ...
                        <hr>
                        <div class="d-flex">
                            <button class="btn btn-success ml-auto" type="submit">B a y a r</button>
                        </div>
                    </form>
                </div>
            </div>
